    ...
    <div class="row justify-content-center">
      <div class="col-md-4">
        <div class="card p-4">
          ...
          <p class="text-muted mb-4">Gestão de freelancers, restaurantes e vagas.</p>
          <?php if($error): ?><div class="alert alert-danger"><?=e($error)?></div><?php endif; ?>
          <form method="post">
            <div class="form-group">
              <label>E-mail</label>
              <input class="form-control" name="email" type="email" required value="admin@admin.com">
            </div>
            <div class="form-group">
              <label>Senha</label>
              <input class="form-control" name="password" type="password" required value="admin123">
            </div>
